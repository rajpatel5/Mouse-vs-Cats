...
void handleDeadEnds(double graph[graph_size][4], bool deadPaths[graph_size], int num_cheese, int cheese_location[10][2], double closest_cheese, double closest_cat, int position, double *utility_val);
...
void breadthFirstSearch(double gr[graph_size][4], double distances[graph_size], int cheese_locations[10][2], int cat_locations[10][2], int cats, int cheeses, int start_index);
